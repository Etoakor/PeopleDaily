...
class Weibo(object):
    cookie = {'Cookie': 'ALF=1568788813; SCF=AhTDWs6QrKF1eq_rbd2XuqWnQmzUSXDgTXeAOxPEjA21bWBZli9gXdTHTGS7kzUOlAYZdeX_bcQHD0kLe9E4Jg4.; SUB=_2A25wXjUgDeRhGeBL41YQ-SzIwjyIHXVToVtorDV6PUJbktANLVfMkW1NRtqlDwIdmXz8qx_mZiLATYQ75ideeeTe; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFvBXJC8b-cYA8u2pcEkec.5JpX5K-hUgL.Foqf1hBp1KzX1K52dJLoI0qLxK-LBo5L12qLxK-LBK-LBoeLxKnL12zLBKqLxKMLB.zL1heLxK-LB.qL1heLxKqL1h5L1h2t; SUHB=0k1Ct_0B9fpDmq; SSOLoginState=1566197104'}  # 将your cookie替换成自己的cookie
    ...
    def __init__(self, user_id, filter=0, pic_download=0, video_download=0):
        ...
        self.user_id = user_id  # 用户id,即需要我们输入的数字,如昵称为"人民日报"的id为2803301701
    ...
    def get_nickname(self):
        ...
        try:
            ...
            if self.nickname == u'登录 - 新' or self.nickname == u'新浪':
                sys.exit(u'cookie错误或已过期,请按照微信公众号：Etoakor中方法重新获取')
